...
func (c *categoryServiceClient) ListCategories(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CategoryListResponse, error) {
...
func (UnimplementedCategoryServiceServer) ListCategories(context.Context, *Empty) (*CategoryListResponse, error) {
